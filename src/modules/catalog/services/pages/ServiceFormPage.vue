<template>
  ...
  <div class="container">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
      ...
      <router-link :to="{ name: 'services.index' }" class="btn btn-secondary">
        Volver
      </router-link>
    ...
    <form @submit.prevent="save">
        ...
        <div class="card-body">
          ...
          <div class="row">
            ...
            <div class="col-md-6 mb-3">
              ...
              <select v-model="form.provider_id" class="form-select" required>
            ...
            <div class="col-md-6 mb-3">
              ...
              <select v-model="form.service_category_id" class="form-select" required>

                <option value="">
                  Seleccione...
                </option>

                <option v-for="category in serviceCategoryStore.items" :key="category.uuid" :value="category.id">
                  {{ category.name }}
                </option>
              </select>
      ...
      <div class="mt-4">
        ...
        <router-link class="btn btn-secondary ms-2" :to="{ name: 'services.index' }">
